...
export default function App() {
  const [tab, setTab] = useState<Tab>('create'); const [loading, setLoading] = useState(false); const [result, setResult] = useState<ImagePipelineResult | null>(null); const [error, setError] = useState(''); const [apiOk, setApiOk] = useState<boolean | null>(null); const [size, setSize] = useState('1024 × 1024');
