...
export function Sidebar({ apiOk }: { apiOk: boolean | null }) {
  return <aside className="hidden w-[244px] shrink-0 flex-col bg-[#19232b] text-[#b6c0c5] lg:flex">
    ...
    <nav className="flex-1 overflow-y-auto px-3 py-5">
      ...
      <div className="mt-8 px-3 pb-2 text-[10px] font-bold tracking-[0.16em] text-[#718087]">LIBRARY</div>
      <button className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-[13px] text-[#b6c0c5] hover:bg-white/8 hover:text-white"><span className="text-base text-[#8f9ba1]">▤</span>商品项目<span className="ml-auto text-[11px] text-[#718087]">0</span></button><button className="mt-1 flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-[13px] text-[#b6c0c5] hover:bg-white/8 hover:text-white"><span className="text-base text-[#8f9ba1]">◷</span>任务中心<span className="ml-auto text-[11px] text-[#718087]">0</span></button>
    </nav>
